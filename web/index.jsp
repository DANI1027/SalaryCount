...
function change(n){
	if(n==1){
	document.getElementById("frame").src="frame1.jsp";
	...
	<div class="content">
		<div class="syshead">
			<div class="clearfix">
				...
				<p class="right"><span>员工</span><a href="javascript:void(0);"><%out.print((String)session.getAttribute("name"));%></a><a class="outsys" title="退出系统" href="login.html"><img src="images/index/outsys.gif" width="16" height="16" alt="" />退出</a></p>
			</div>
		</div>
		<div class="sysmain clearfix">
            ...
            <div class="sysmenub">
            <iframe  src="frame1.jsp" height="70%" width="100%" frameborder="0" border="0"  name="frame"  id="frame"></iframe>
			</div>
